  ...
  render() {
    ...
    return (
      <div className="container home p-5">
        <h1 className="text-white text-center font-weight-bolder">
          {" "}
          Welcome To Adinkra symbols <br /> Quiz Game{" "}
        </h1>
        <div className="row greet justify-content-center text-center p-2">
          <div className="col-12 col-sm-12 adinkra">
            <p className="col-12 lead text-white ">
              <a className="text-white font-weight-bolder" rel="_blank" href="http://www.adinkrasymbols.org/">
                {" "}
            ...
            <button className="btn">
              {" "}
              <Link to="/game">
                <a className="btn btn-lg btn-warning" href={App}>
                  {" "}
                  Try Quiz{" "}
                </a>{" "}
              </Link>
